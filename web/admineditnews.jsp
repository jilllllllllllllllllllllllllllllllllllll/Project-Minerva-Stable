			...
			<div class="left block">
				<div class="formContainer">
					...
					<form method="post" action="editnews.html?id=<%=Integer.parseInt(request.getParameter("id"))%>">
						...
						<input type="text" placeholder="Title" name='newsTitle' required="required" value="${news.newsTitle }">
						<textarea placeholder="News/Announcement" name='messageInput' required="required">${news.newsMessage}</textarea>
