			...
			<div class="left block">
				<div class="formContainer">
					...
					<form method="post" action="editbooks.html">
						<input type="number" placeholder="${book.accNum}" min="1" max="99999999" name="accNum" required="required" value="${book.accNum}" readonly>
						<input type="text" placeholder="Title" name="bookTitle" required="required" value="${book.bookTitle}">
						<div class="author">
							<input type="text" placeholder="Author" name="author" required="required" value="${book.author}">
							<input type="text" placeholder="Class" name="class" required="required" value="${book.bookClass}"> 
						</div>
						<div class="edition">
							<input type="text" placeholder="Edition" name="edition" required="required" value="${book.edition}">
							<input type="text" placeholder="Volume" name="volume" required="required" value="${book.volume}">
							<input type="number" placeholder="Pages" min="1" max="9999" name="pages" required="required" value="${book.pages}">
						</div>
						<div class="edition">
							<input type="text" placeholder="Publisher" name="publisher" required="required" value="${book.publisher}">
							<input type="number" placeholder="Year" min="1" max="3000" name="year" required="required" value="${book.year}">
						<select name = "genre">
						...
						<select name = "availability" required="required" value="${book.availability}">
